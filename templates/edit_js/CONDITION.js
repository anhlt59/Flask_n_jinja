...
let Agruments_input = {{vars|length}};
function Agruments_add() {
   let x = document.getElementById("Agruments_table").rows.length ;
    ...
    cell3.innerHTML = "<input type='text' class='form-control' placeholder='Value' type='text' >"
   
    cell4.innerHTML = "<input type='text' class='form-control' placeholder='Condition' type='text' >"
