  function oid_snmp(){
    ...
    function oid_hides() {
      ...
      }else{ alert("No, you missed oid - snmp fill");}
    }

    let input = {{oid["get"]|length}};
    function oid_add_get() {
      ...
      if ((document.getElementById("Version").value) != "") {
        ...
        cell1.innerHTML = "<input  type='text' placeholder='Oid Get Var' class='form-control' onkeyup='FConkeyup(this)' type='text' required>"
        cell2.innerHTML = "<input type='text' class='form-control' placeholder='Oid Get Value' onkeyup='FConkeyup(this)' type='text' required>"
    ...
    function oid_add_walk() {
      ...
      if ((document.getElementById("Version").value) != "") {
        ...
        cell1.innerHTML = "<input  type='text' placeholder='Oid Walk Var' class='form-control' onkeyup='FConkeyup(this)' type='text' required>"
        cell2.innerHTML = "<input type='text' class='form-control' placeholder='Oid Walk Value' onkeyup='FConkeyup(this)' type='text' required>"
